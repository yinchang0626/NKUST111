...
{
    [DbContext(typeof(NKUSTDbContext))]
    [Migration("20220602030940_test")]
    partial class test
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NKUST.Courses.Course", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.Property<string>("學分數")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("學制")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("年級")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("必選修")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("校名")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("系所名稱")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("總修課人數")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("課程名稱")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("開課學期")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("開課年度")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("開課老師")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("NKUST.Courses.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NKUST.Courses.StudentCourse", b =>
                {
            ...
            modelBuilder.Entity("NKUST.Courses.StudentCourse", b =>
                {
                    b.HasOne("NKUST.Courses.Course", null)
                        .WithMany("StudentCourses")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NKUST.Courses.Student", null)
                        .WithMany("StudentCourses")
