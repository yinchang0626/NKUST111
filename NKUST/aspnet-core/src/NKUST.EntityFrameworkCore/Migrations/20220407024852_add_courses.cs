    ...
    public partial class add_courses : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    開課年度 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    開課學期 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    校名 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    課程名稱 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    系所名稱 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    年級 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
